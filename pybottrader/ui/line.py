...
class HorizontalLine(QLineSeries):
    def __init__(self, value: float, name: str = "Level", color: Qt.GlobalColor = Qt.red):
        super().__init__()
        self.setName(name)
        self.value = value
        pen = QPen(color)
...
class LineChart(QWidget):
    ...
    def add_horizontal_line(self, value: float, name: str = "Level", color: Qt.GlobalColor = Qt.red):
