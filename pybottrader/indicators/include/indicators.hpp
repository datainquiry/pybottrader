...
namespace indicators {
    ...
    /**
    * Indicator class
    * This class is a base class for all indicators. It provides a way to store
    * the values of the indicator in a circular buffer.
    * The class is templated to allow for any type of data to be stored.
    */
    template <typename T>
    class Indicator {
    protected:
    ...
    public:
        ...
        * @param mem_size: size of the circular buffer
        */
        ...
        * It is just a virtual destructor in case derived
        * classes need to do something in their destructors.
        */
        virtual ~Indicator() {}

        /**
        * Get the value of the indicator at a given index
        * @param key: index of the value to get. 0 is the most recent value.
        *     If `mem_size`is greater than 1, then -1 is the previous value,
        *     -2 is the value before that, and so on.
        * @return value of the indicator at the given index
        ...
        * The value will be stored in the next position of the circular buffer.
        * If the buffer is full, the oldest value will be overwritten.
        * @param value: value to store in the circular buffer
        */
        void push(T value) {
        ...
        /**
        * Get the most recent value of the indicator.
        * It is a wrapper around the operator[] method.
        * @param key: index of the value to get. 0 is the most recent value.
        *    If `mem_size`is greater than 1, then -1 is the previous value,
        *    -2 is the value before that, and so on.
        * @return most recent value of the indicator
        * @throws std::out_of_range if the index is out of range
        */
